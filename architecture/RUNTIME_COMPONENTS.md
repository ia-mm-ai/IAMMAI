...
- but by preserving contact in a form that can later be reconstructed without silent disappearance.
...
The following remain open for later implementation decisions:
