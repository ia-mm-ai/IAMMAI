...
- transition legality
- later contribution-role consistency if required
...
- held
- released
- optional reason references later
...
If these distinctions collapse, the body betrays the law.
...
Products may later implement or host parts of this architecture.
...
- later witness ecology expansion
...
This is the skeleton, not the final world-body.
